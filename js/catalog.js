...
(function () {
  ...
  var addGoodInCart = function (title) {
    ...
    if (indexOfGoodInCart === -1) {
      var addedGoodObject = {
        name: window.data.goods[indexOfGood].name,
        picture: window.data.goods[indexOfGood].picture,
        amount: window.data.goods[indexOfGood].amount,
        price: window.data.goods[indexOfGood].price,
        orderedAmount: 1
      };
